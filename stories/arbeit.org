...
<link rel="stylesheet" href="/assets/scripts/katex/katex.min.css" integrity="sha384-wE+lCONuEo/QSfLb4AfrSk7HjWJtc4Xc1OiB2/aDBzHzjnlBP4SX7vjErTcwlA8C" crossorigin="anonymous">
<script src="/assets/scripts/katex/katex.min.js" integrity="sha384-tdtuPw3yx/rnUGmnLNWXtfjb9fpmwexsd+lr6HUYnUY4B7JhB5Ty7a1mYd+kto/s" crossorigin="anonymous"></script>
...
#+BEGIN_EXPORT html
<script src= "https://sdll.github.io/assets/scripts/d3.v3.min.js" > </script> 
<script>
...
d3.tsv("/assets/org/sfscore", function(d) {
  ...
  y.domain(d3.extent(data, function(d) { return d.MAT157; }));
